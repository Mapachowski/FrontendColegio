    ...
    try {
      ...
      if (response.data.success) {
        ...
        if (miDocente) {
          ...
          // Actualizar filtros con el idDocente correcto
          const nuevosFiltros = { ...filtros, idDocente: idDocente };
          setFiltros(nuevosFiltros);
          // Cargar catálogos y asignaciones en paralelo con el idDocente correcto
          await Promise.all([
            cargarCatalogos(),
          ...
          title={
            <span>
              ...
              <span style={{ color: '#666', fontSize: '14px', marginLeft: '8px' }}>
                ({asignacionSeleccionada.NombreGrado} - Sección {asignacionSeleccionada.NombreSeccion} - {asignacionSeleccionada.NombreJornada})
              </span>
            </span>
          }
          style={{ marginBottom: '24px' }}
